...
class ResultSheet(models.Model):
    ...
    score_1ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_1exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_2 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_2', null=True, blank=True, )
    score_2ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_2exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_3 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_3', null=True, blank=True,)
    score_3ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_3exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_4 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_4', null=True, blank=True,)
    score_4ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_4exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_5 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_5', null=True, blank=True,)
    score_5ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_5exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_6 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_6', null=True, blank=True,)
    score_6ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_6exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_7 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_7', null=True, blank=True,)
    score_7ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_7exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_8 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_8', null=True, blank=True,)
    score_8ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_8exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_9 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_9', null=True, blank=True,)
    score_9ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_9exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_10 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_10', null=True, blank=True,)
    score_10ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_10exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_11 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_11', null=True, blank=True,)
    score_11ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_11exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_12 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_12', null=True, blank=True,)
    score_12ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_12exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_13 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_13', null=True, blank=True,)
    score_13ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_13exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_14 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_14', null=True, blank=True,)
    score_14ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_14exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_15 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_15', null=True, blank=True,)
    score_15ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_15exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    subject_16 = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='subject_16', null=True, blank=True,)
    score_16ca = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(40)]) 
    score_16exam = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(0), MaxValueValidator(60)]) 
    remark = models.CharField(max_length=150, blank=True, ) 
