    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge', models.ForeignKey(default='none', on_delete=django.db.models.deletion.CASCADE, to='students.badge')),
                ('class_group', models.ForeignKey(default='none', on_delete=django.db.models.deletion.CASCADE, to='students.classgroup')),
                ...
                ('current_class', models.ForeignKey(default='none', on_delete=django.db.models.deletion.CASCADE, to='curriculum.standard')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='student_username')),
            ],
        ),
        migrations.CreateModel(
            name='Mystudents',
